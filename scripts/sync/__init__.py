...
# staleness detection. Phase 4 (separate PR) ships ``worktree`` — git
# worktree index mismatch detection.
#
...
"""CodeLens sync subpackage — index-vs-worktree reconciliation.

Public modules:

* :mod:`sync.pending` — per-file staleness detection (issue #66 Phase 1).
