...
# NOTE: is_bundled_file defined below (after BUNDLED_FILE_PATTERNS / BUNDLED_DIR_SEGMENTS)
...
# Alias: some engines import as is_generated_source_file
is_generated_source_file = is_generated_file
