...
export const CODELENS_COMMANDS: CommandDef[] = [
  ...
  // Agent-First
  { name: 'ask', description: 'Ask a question in natural language', category: 'Agent', icon: '🤖', args: [{ name: 'question', required: true, description: 'Natural language question' }, { name: 'workspace', required: true, description: 'Workspace path' }] },
