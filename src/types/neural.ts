...
export const CODELENS_COMMANDS: CommandDef[] = [
  ...
  // Agent
  { name: 'ask', description: 'Ask a natural language question about the codebase', category: 'Agent', icon: '🤖', args: [{ name: 'question', required: true, description: 'Natural language question' }, { name: 'workspace', required: true, description: 'Workspace path' }] },
